...
// MARK: - Version 3 (current): games won before the first tracked game

/// The live model classes. `SavedMatch` and `SavedRefereeMatch` gain
/// `player1GamesBefore` / `player2GamesBefore` (default 0) for matches that
/// were picked up at game 2 or later; a lightweight migration from version 2.
...
typealias SquashAnalyzerCurrentSchema = SquashAnalyzerSchemaV3

enum SquashAnalyzerMigrationPlan: SchemaMigrationPlan {
    static var schemas: [any VersionedSchema.Type] {
        [SquashAnalyzerSchemaV0.self, SquashAnalyzerSchemaV1.self, SquashAnalyzerSchemaV2.self, SquashAnalyzerSchemaV3.self]
    }

    static var stages: [MigrationStage] { [v0ToV1, v1ToV2, v2ToV3] }
